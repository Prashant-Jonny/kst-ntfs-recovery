...
#define USING_QT_TYPES true
#define STRUCT_DECLORATION_FIX true

#include "ntfs3g_types.h"
#include "ntfs3g_endians.h"
#include "ntfs3g_support.h"

/* The NTFS oem_id */
#define magicNTFS	const_cpu_to_le64(0x202020205346544e)	/* "NTFS    " */
#define NTFS_SB_MAGIC	0x5346544e				/* 'NTFS' */
#define magicEND_OF_BOOT_SECTOR const_cpu_to_le16(0xaa55)
 ...
 */
enum IDENTIFIER_AUTHORITIES {					/* SID string prefix. */
 ...
 */
enum RELATIVE_IDENTIFIERS {					/* Identifier authority. */
 ...
 */
union SID_IDENTIFIER_AUTHORITY {
	struct {
 ...
 */
typedef struct PREDEFINED_ACE_TYPES {
